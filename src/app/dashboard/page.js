    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
        ...
        <button
          type="button"
          onClick={() => setPreviewFile(null)}
          className="w-9 h-9 flex items-center justify-center rounded-lg text-slate-500 hover:bg-slate-100 hover:text-slate-800"
        >
          ✕
        </button>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm">
          ...
          {recentQuery.data?.files?.length > 0 ? (
            ...
            <div>
              ...
              <div className="grid grid-cols-[minmax(350px,1fr)_220px_150px] gap-4 px-6 py-4 bg-slate-50 border-b border-slate-200 text-xs font-semibold uppercase tracking-wide text-slate-400">
              ...
              {recentQuery.data.files.map((file) => (
                ...
                <button
                  ...
                  className="w-full grid grid-cols-[minmax(350px,1fr)_220px_150px] gap-4 items-center px-6 py-4 border-b border-slate-100 last:border-b-0 hover:bg-slate-50 transition text-left"
                >
